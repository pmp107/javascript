...
//Function to fetch all tasks from local storage and populate on UI. 
...
taskbox.forEach(column => {
    ...
    column.addEventListener("click", event => {
        ...
        // To toggle between edit-update button & enable/disable input field.
