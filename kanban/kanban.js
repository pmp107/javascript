/**
* Class Name: Kanban => Involves function to manipulate tasks.
* Author: 
* Date Created:
* Modified: 
*/
export default class Kanban{
    ...
    //getTasks() returns array of tasks [not used as of now].
    ...
    static insertTask(columnId, content){
        ...
        column.tasks.push(task); //by reference we are modifying main data array.
        console.log(data);
        save(data);
        return task;
    }
    ...
    static updateTask(taskId, updatedInformation){
        ...
        //currentColumn => is an whole task column in which particular task is found.
